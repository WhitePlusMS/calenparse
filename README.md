...
|                      **日历视图**                      |                        **列表管理**                        |                        **事件详情**                        |
| :----------------------------------------------------: | :--------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="assets/主界面.png" width="240" alt="主界面"> | <img src="assets/列表界面.png" width="240" alt="列表界面"> | <img src="assets/事件详情.png" width="240" alt="事件详情"> |

|                        **标签系统**                        |                        **主题定制**                        |                         **分享导出**                         |
| :--------------------------------------------------------: | :--------------------------------------------------------: | :----------------------------------------------------------: |
| <img src="assets/标签管理.png" width="240" alt="标签管理"> | <img src="assets/主题设置.png" width="240" alt="主题设置"> | <img src="assets/分享为图片.png" width="240" alt="分享功能"> |
...
graph TD
    subgraph Client ["客户端 (Vue 3)"]
        User[用户] -->|输入自然语言| Input[AI 浮动输入框]
        Input -->|API 请求| LLM[大语言模型]
        LLM -->|解析结果 JSON| Parser[事件生成器]
    ...
    subgraph Server ["服务端 (Supabase)"]
        direction TB
        DB_Visitor[(visitor_events 表)]
        DB_Admin[(events 表)]
        DB_Session[(visitor_sessions 表)]
        
        Visitor -->|Fingerprint ID| DB_Visitor
        Visitor -->|配额监控| DB_Session
        Admin -->|User ID| DB_Admin
    end

    Mode -.->|切换登录| Auth[Supabase Auth]
